...
await page.locator('.ticker-pause').click();assert.equal(await page.locator('.ticker-pause').getAttribute('aria-pressed'),'true');await page.locator('.ticker-pause').evaluate(e=>e.blur());await page.mouse.move(0,0);assert.equal(await page.locator('.development-track').evaluate(e=>getComputedStyle(e).animationPlayState),'paused');
